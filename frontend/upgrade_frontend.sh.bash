set -e
echo "--- UPGRADING FRONTEND WITH ALL FEATURES (DIRECT COMMAND) ---"

npm install lucide-react sonner @radix-ui/react-dialog @radix-ui/react-label @radix-ui/react-slot @radix-ui/react-switch @tanstack/react-virtual class-variance-authority clsx tailwind-merge react-markdown remark-gfm zod @hono/zod-validator
